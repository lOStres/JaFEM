...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1] == '-i':
        ...
        con = None
        try:
	#prepei na allaksei auto gia na mporoume na to xrhsimopoioume kai oi 2
            ...
            for filename in os.listdir(directory):
                ...
                if extension == "csv":
                    ...
                    print("a")
                    #soundfile doesnt work for .mp3, for now just excluding them
                    if(not(filename.endswith('.mp3'))):
                        featureV = extractFeatures(directory,filename)
                        link = directory + '/' + name + '.' + extension
		            #insert to spatialindex
                        
                        rtree.insert(index_id, (featureV[0][0], featureV[1][0], featureV[2][0], featureV[3][0], featureV[0][0], featureV[1][0], featureV[2][0], featureV[3][0]), obj = link)
                        index_id+=1
